    ...
    return SliverAppBar(
      ...
      actions: [
        IconButton(
          ...
          tooltip: isSearchVisible ? context.l10n.connCloseSearch : context.l10n.connSearch,
        ),
        IconButton(
    ...
    if (confirmed == true) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(context.l10n.connDeletedMessage(connection.name))),
        );
      }
    }
  }
...
class _ConnectionCardState extends ConsumerState<_ConnectionCard> {
  ...
  Future<void> _killHerdrWorkspace(MultiplexerSession workspace) async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(context.l10n.connWorkspaceClosed(workspace.name))),
        );
      }
    } catch (e) {
      if (!mounted) return;
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  isAttached ? context.l10n.connAttached : context.l10n.connDetached,
                  style: GoogleFonts.jetBrainsMono(
                    fontSize: 10,
                    fontWeight: FontWeight.w500,
                    color: isAttached
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        FilledButton(
          onPressed: _submit,
          child: Text(context.l10n.connCreate),
        ),
      ],
    );
  }
